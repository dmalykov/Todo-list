...
const toggleAndTaskForm = () => {
	addTaskForm.classList.toggle ("active");
	blackBackdrop.classList.toggle ("active");
	addTaskBtn.classList.toggle ("active");
};

addTaskBtn.addEventListener("click", toggleAndTaskForm);
blackBackdrop.addEventListener("click", toggleAndTaskForm);
...
cancelBtn.addEventListener("click", toggleAndTaskForm);
